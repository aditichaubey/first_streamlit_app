...
streamlit.header('Breeakfast Favorites')
...
#take the jason version of the response and normlize it.
...
fruit_choice1 = streamlit.text_input('What fruit would you like to add?','cantaloupe')
